<template>
    <div class=" mx-5">
        <form class="mt-2 mx-auto max-w-4xl py-2 px-6 rounded-full bg-gray-50 border flex focus-within:border-gray-300">
            ...
            <i class="fa-solid fa-camera relative top-1 right-40 text-2xl"></i>
        </form>
