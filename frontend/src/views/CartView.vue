  ...
  <div class="container mx-auto p-8 rounded-xl px-14">
    <div class="flex bg-white p-3">
      ...
      <div class="w-2/3 pr-8">
        ...
        <div v-else>
          <div v-for="item in cartItems" :key="item.id" class="flex mb-4 border-2 p-2 rounded-xl">
            ...
            <div class="w-1/2 flex items-center justify-end">
              ...
              <button @click="decrementQuantity(item)" class="text-gray-500 mr-2" v-if="item.selected">-</button>
              <span class="mr-2" v-if="item.selected">{{ item.quantity }}</span>
              <button @click="incrementQuantity(item)" class="text-gray-500 mr-4" v-if="item.selected">+</button>
...
const cartItems = ref([
  { id: 1, name: 'Áo sơ mi Bamboo NX25', price: '199000', quantity: 2, image: 'https://pos.nvncdn.com/a36e05-151378/ps/20231213_iAl9k6EuKP.jpeg', selected: false },
