<template>
    <!-- Modal content -->
    <div class="relative mt-1 p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
        <!-- Modal header -->
            ...
            <div class="grid gap-4 mb-4 sm:grid-cols-2">
                <div>
                    <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Product
                        Name</label>
                    <input type="text" name="name" id="name" v-model="productName"
                ...
                <div>
                    ...
                    <select id="supplier" v-model="selectedSupplier"
                        ...
                        <option v-for="supplier in suppliers" :key="supplier.id" :value="supplier.code">{{ supplier.name }}
                        </option>
                    </select>
                </div>
                <div>
            ...
            <div class="mb-4">
                ...
                <div class="flex justify-center items-center w-full">
                    <label for="dropzone-file"
                        class="flex flex-col justify-center items-center w-full h-24 bg-gray-50 rounded-lg border-2 border-gray-300 border-dashed cursor-pointer dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
